...
export interface CompletePostDto {
  post_id: string;
  title: string;
  /** @format date-time */
  created_at: string;
...
> extends HttpClient<SecurityDataType> {
  posts = {
     ...
     * @request POST:/posts
     */
    postsControllerCreate: (data: PostDto, params: RequestParams = {}) =>
      this.request<PostBaseDto, any>({
        path: `/posts`,
        method: "POST",
        body: data,
     ...
     */
    postsControllerFindOne: (id: string, params: RequestParams = {}) =>
      this.request<SinglePostDto, void>({
        path: `/posts/${id}`,
        method: "GET",
        format: "json",
        ...params,
    ...
    postsControllerUpdate: (
      ...
      this.request<CompletePostDto, void>({
        path: `/posts/${id}`,
        method: "PUT",
        body: data,
        type: ContentType.Json,
     ...
     */
    postsControllerRemove: (id: string, params: RequestParams = {}) =>
      this.request<
        {
          message?: string;
        },
